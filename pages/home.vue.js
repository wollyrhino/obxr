var Home = {
	template: `<div id="home_page">
	<div id="home_headline_banner">
	<h1>Easy, Affordable, Local Car Rentals.</h1><p>Run a quick errand or start your [gig] with one of our cars.</p>
	</div>
	<br><br>
	<div id="message_box">
	<h3>Why Rent your next car with OBAX?</h3>
	<ul>We Specialize in helping GIG drivers get on the road,<br> but there a many reason you may want to rent a car with OBAX<br><br>
	...
	<router-link id="nav_link" tag="button" class="nav-link" to="rentalform">Drive</router-link> 
